$(function () {
    ...
    $(".react-pc>.pc-hover-box").mouseover(function(){
        $(this).hide();
        $(this).next().stop().animate({"top":"-1060px"},5500)
    });
    ...
    $(".monami-pc>.pc-hover-box").mouseover(function(){
        $(this).hide();
        $(this).next().stop().animate({"top":"-931px"},5500)
    });
    ...
    $(".millie-pc>.pc-hover-box").mouseover(function(){
        $(this).hide();
        $(this).next().stop().animate({"top":"-2485px"},7500)
    });
    ...
    $(".outback-pc>.pc-hover-box").mouseover(function(){
        $(this).hide();
        $(this).next().stop().animate({"top":"-943px"},5500);
    });
    ...
    $(".romi-pc>.pc-hover-box").mouseover(function(){
        $(this).hide();
        $(this).next().stop().animate({"top":"-963px"},5500)
    });
